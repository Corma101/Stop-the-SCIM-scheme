    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-3xl px-6 py-16">
        <div className="space-y-4 text-muted-foreground font-mono text-sm leading-relaxed">
          ...
          <p className="text-secondary-foreground">
            They charge more to remove access. They upsell security as a feature. They monetize what should be baseline
            hygiene.
          </p>
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <ul className="space-y-3 text-muted-foreground font-mono text-sm leading-relaxed">
            <li className="flex items-start gap-2">
              <span className="text-foreground mt-0.5">→</span> Access granted automatically. Access revoked
              immediately.
            </li>
            <li className="flex items-start gap-2">
              <span className="text-foreground mt-0.5">→</span> Security included by default.
            </li>
            <li className="flex items-start gap-2">
              <span className="text-foreground mt-0.5">→</span> No upsell. No artificial tiers. No paying extra to be
              safe.
            </li>
          </ul>
      ...
      <section className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="space-y-4 text-muted-foreground font-mono text-sm leading-relaxed">
          ...
          <p>
            Imagine an employee leaving the company. Even if SSO access is revoked, local accounts or stale API tokens
      ...
      <section className="mx-auto max-w-3xl px-6 pb-16">
        ...
        <ul className="space-y-3 text-muted-foreground font-mono text-sm leading-relaxed">
          <li className="flex items-start gap-2">
            <span className="text-foreground mt-0.5">→</span> Automated provisioning and deprovisioning is a core
            security requirement
          </li>
          <li className="flex items-start gap-2">
            <span className="text-foreground mt-0.5">→</span> Identity lifecycle management should not be paywalled
          </li>
          <li className="flex items-start gap-2">
            <span className="text-foreground mt-0.5">→</span> Security features should not be upsell levers
          </li>
          <li className="flex items-start gap-2">
            <span className="text-foreground mt-0.5">→</span> Transparency drives better vendor behavior
          </li>
          <li className="flex items-start gap-2">
            <span className="text-foreground mt-0.5">→</span> Customers deserve clarity before signing contracts
          </li>
        </ul>
        <p className="mt-6 text-sm font-mono text-muted-foreground">
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="space-y-4 text-muted-foreground font-mono text-sm leading-relaxed">
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-foreground mt-0.5">→</span> Document which vendors restrict SCIM behind premium
                plans
              </li>
              <li className="flex items-start gap-2">
                <span className="text-foreground mt-0.5">→</span> Highlight companies that make lifecycle automation
                accessible
              </li>
              <li className="flex items-start gap-2">
