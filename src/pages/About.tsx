    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-3xl px-6 py-16">
        <div className="space-y-4 text-muted-foreground font-mono text-sm leading-relaxed">
          ...
          <p className="text-secondary-foreground">SCIM — the standard for automated provisioning and deprovisioning — exists so companies can manage identity at scale without spreadsheets, tickets, and human delay. It closes gaps. It reduces risk. It protects customers.The SCIM system has long been ago been established as an industry standard and can be found in the large majority of tools.
